...
export default function splitByWords(str, splitLength) {
    if (splitLength <= 0)
        throw new Error("Split Length cannot be less than or equal to 0");
    if (str === "")
        return [];
...
//# sourceMappingURL=splitByWords.js.map